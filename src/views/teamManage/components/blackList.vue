<template>
  <div>
    <el-table v-loading="loading" class="tb" :data="tableData" style="width: 100%" max-height="520">
      <el-table-column prop="teamName" width="150" align="center" label="团队名称">
      </el-table-column>
      <el-table-column prop="direction" min-width="150" align="center" label="方向">
      </el-table-column>
      <el-table-column prop="createTime" min-width="150" align="center" label="创建时间">
      </el-table-column>
      <el-table-column prop="teamScore" min-width="150" align="center" label="团队得分">
      </el-table-column>
      <el-table-column prop="description" align="center" min-width="300" label="团队简介">
      </el-table-column>
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="detail(scope.row)">查看</el-button>
          <el-button size="mini" type="success" @click="remove(scope.row)">撤销</el-button>
        </template>
      </el-table-column>
    </el-table>
