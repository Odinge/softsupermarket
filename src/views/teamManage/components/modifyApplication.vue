<template>
  <div>
    <el-table v-loading="loading" class="tb" :data="tableData" style="width: 100%" max-height="520">
      <el-table-column prop="modificationPlace" width="150" align="center" label="修改类型">
      </el-table-column>
      <el-table-column prop="originalData" min-width="300" align="center" label="原内容">
      </el-table-column>
      <el-table-column prop="modificationContent" align="center" min-width="300" label="新内容">
      </el-table-column>
      <el-table-column label="操作" width="250" align="center">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="detail(scope.row)">查看</el-button>
          <el-button size="mini" type="success" @click="agree_refuse(scope.row,'agree')">同意</el-button>
          <el-button size="mini" type="danger" @click="agree_refuse(scope.row,'refuse')">拒绝</el-button>
        </template>
      </el-table-column>
    </el-table>
