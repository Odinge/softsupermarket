<template>
  <div class='team-manage'>
    ...
    <a href="http://www.ghjhhyuyuy.xin:8080/v1/nonpub/examine/getAllTeamsToExcel">
      ...
      <div class="in" @click="handleImportTeam">
        <span>导入团队</span>
    ...
    <a href="http://www.ghjhhyuyuy.xin:8080/v1/nonpub/examine/getAllTeamsToExcel">
      ...
      <component
        :is="component"
        :extend="extend"
        @msgNumber="handleMsgNumber()"
        @updateMsgNumber="getMsgNumber"></component>
    </div>
</template>
<script>
  ...
  export default {
    components:{allTeam,modifyApplication,blackList},
    data() {
      return {
        activeName: 'allTeam',
        component:'allTeam',
