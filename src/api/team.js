...
//提交修改团队信息请求
export const modifyApplicaiton = (
  teamId,
  modificationType,
  modificationPlace,
  modificationContent,
  ...
  axios.post("/v1/nonpub/examine/modificationTeam", {
    teamId,
    modificationType,
    modificationPlace,
    modificationContent,
...
export const agreeModify = (modificationId, state) =>
  axios.post("/v1/nonpub/examine/modificationTeamJudge", {
    modificationId,
    state
  });

//审核新申请团队
export const handleNewApplication = (teamId, state) =>
  axios.post("/v1/nonpub/examine/team", { teamId, state });

//获取新建团队申请
export const getNewApplication = () => axios.get("/v1/nonpub/examine/get/team");
