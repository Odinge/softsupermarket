...
import { getToken, setCookie, getCookie, delCookie, proxyUrl, roles } from './../utils/auth';
...
// setCookie("JSESSIONID", "8805E2AE46263821EF4ABEC00593E710", { path: '/' });
...
export const getMessageById = messageId =>
    axios.get('/v1/nonpub/supervise/getMessageByMessageId', { params: { messageId } });

// 根据消息状态获取信息
export const getMessageByState = messageState =>
    axios.get('/v1/nonpub/supervise/getMessageByState', { params: { messageState } });

// 根据接收方获取信息
export const getMessageByUserGet = userGet =>
    axios.get('/v1/nonpub/supervise/getMessageByUserGet', { params: { userGet } });
...
export const getRole = userId =>
    axios.get("/v1/nonpub/examine/getRole", { params: { userId } });
