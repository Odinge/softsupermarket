...
export const publish = data =>
    axios.post("/v1/nonpub/collect/need", data);
...
export const projectsClassifyByState = state =>
    axios.get("/v1/nonpub/examine/projectsClassifyByState", { params: { state } });

// 根据项目进度获取项目
export const getProjectByProgress = progress =>
    axios.get("/v1/nonpub/supervise/getProjectByProgress", { params: { progress } });
...
export const examineModificationProject = (modificationId, state) =>
    axios.post("/v1/nonpub/examine/modificationProjectJudge", { modificationId, state });
...
export const getModificationProjectById = modificationId =>
    axios.get("/v1/nonpub/supervise/projectModificationState", { params: { modificationId } });
...
export const getDelays = () =>
    axios.get("/v1/nonpub/examine/get/delay");
...
export const downloadAchievement = (runId, timeNode) =>
    axios.get("/v1/nonpub/supervise/downloadAchievement", { params: { runId, timeNode } });

// 下载项目计划文档
export const downloadProjectDocument = (projectId, teamId) =>
    axios.get("/v1/nonpub/supervise/downloadProjectDocument", { params: { projectId, teamId } });
...
export const getAchievementHistory = (runId, timeNode) =>
    axios.get("/v1/nonpub/supervise/achievementHistory", { params: { runId, timeNode } });
...
export const examineAchievements = (achievementsId, state) =>
    axios.post("/v1/nonpub/examine/updateAchievementsState", { achievementsId, state });

// 上传成果审核状态
export const getAchievementState = achievementsId =>
    axios.get("/v1/nonpub/supervise/achievementCommitState", { params: { achievementsId } });


// ============================获取id==================================
// 根据runId查询delayId和achievementsId
export const getDelayAndAchievementsByRunId = runId =>
    axios.get("/v1/nonpub/supervise/getDelayAndAchievementsByRunId", { params: { runId } })

// 根据projectId查询undertakeId和modificationId
export const getModificationAndUndertake = projectId =>
    axios.get("/v1/nonpub/supervise/getModificationAndUndertake", { params: { projectId } })
...
export const cancelModificationProject = modificationId =>
    axios.post("/v1/nonpub/supervise/cancel/modificationProject", { modificationId });
